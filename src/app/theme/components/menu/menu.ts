...
export const verticalMenuItems = [ 
    ...
    //new Menu (2, 'Test', '/test', null, 'tachometer', null, false, 1),
    //new Menu (2, 'Membership', '/membership', null, 'users', null, false, 0),
    new Menu (2, 'Gérer les employés', '/gerer-emp', null, 'users', null, false, 0), 
    new Menu (3, 'Gérer politiques de travail','/gerer-poli', null, 'laptop', null, false, 0),   
    new Menu (4, 'Gérer les jours fériés', '/gerer-jourferie', null, 'keyboard-o', null, false, 0),
    //new Menu (5, 'Login', '/login', null, 'sign-in', null, false, 0)  
